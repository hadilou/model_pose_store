...
from get_models import GazeboModel
...
if __name__ == '__main__':
	rospy.init_node('store_model_poses_node',
					anonymous=True, log_level=rospy.DEBUG)
	model_to_save_poses = "table1"
	model_to_track_list = [model_to_save_poses]
	model_pose_store_obj = ModelPoseStore(model_to_track_list)
	
	rospack = rospkg.RosPack()
	# get the file path for rospy_tutorials
	path_to_package = rospack.get_path('model_pose_store')
	...
	pose_file_name = model_to_save_poses+".yaml"
